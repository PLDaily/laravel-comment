...
use App\Repositories\Contracts\ModelEventInterface;
use App\Repositories\Contracts\RepositoryEventInterface;
use App\Repositories\Criteria\Criteria;
use App\Repositories\Presenter\Presenter;
use App\Repositories\Contracts\Transformable;
use App\Repositories\Contracts\CriteriaInterface;
use App\Repositories\Contracts\RepositoryInterface;
use App\Repositories\Exceptions\RepositoryException;
use App\Repositories\Traits\RepositoryEventTraits;
/**
 * Class Repository
 *
...
abstract class Repository implements RepositoryInterface, CriteriaInterface, RepositoryEventInterface
{
     ...
     * @return mixed
     */
     public function paginate($perPage = 15, $page = 1, $columns = ['*'])
    {
        $this->applyCriteria();

        $result = $this->model->paginate($perPage, $columns, NULL, $page);
        $this->resetModel();
